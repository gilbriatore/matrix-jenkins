...
/**
 * REST controller for managing {@link br.edu.up.matrix.domain.Curso}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CursoResource {
    ...
    public ResponseEntity<Curso> updateCurso(@PathVariable(value = "id", required = false) final Integer id, @RequestBody Curso curso)
    ...
    public ResponseEntity<Curso> partialUpdateCurso(
        ...
        Optional<Curso> result = cursoRepository
            ...
            .map(existingCurso -> {
                ...
                if (curso.getCargaHorasMinCurso() != null) {
                    existingCurso.setCargaHorasMinCurso(curso.getCargaHorasMinCurso());
                }
                if (curso.getCargaHorasMinEstagio() != null) {
                    existingCurso.setCargaHorasMinEstagio(curso.getCargaHorasMinEstagio());
                }
                if (curso.getPercMaxEstagioAC() != null) {
                    existingCurso.setPercMaxEstagioAC(curso.getPercMaxEstagioAC());
                }
                if (curso.getPercMaxAtividadeDistancia() != null) {
                    existingCurso.setPercMaxAtividadeDistancia(curso.getPercMaxAtividadeDistancia());
                }
