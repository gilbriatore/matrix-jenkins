package br.edu.up.matrix.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof br.edu.up.matrix.service.EmailAlreadyUsedException ||
            ex instanceof br.edu.up.matrix.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof br.edu.up.matrix.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "br.edu.up.matrix");
    }
}
